...
public class MatrixGraph extends AbstractGraphExtended {
    ...
    public void insert(Edge edge) {
        if (!isDirected())
            setEdgeValue(edge.getDest(), edge.getSource(),
                    edge.getWeight());
        else
    ...
    public static void main(String[] args) {
        ...
        MatrixGraph m4 = new MatrixGraph(10,false);
        System.out.println("Matrix graph is testing...");
        try {
            System.out.println("addRandomEdgesToGraph method is working..");
            m4.addRandomEdgesToGraph(5);
            System.out.println("writeGraphToFile method is working and write all imformations to addRandomForListGraphDirected file.");
            m4.writeGraphToFile("addRandomForListGraphDirected.txt");
        }catch (Exception e)
        {
            System.err.println(e);
        }
